                ...
                Some(serde_json::Value::Array(a)) => {
                    ...
                    for v in a {
                        let Some(s) = v.as_str() else {
                            return Some(json(
                                StatusCode::BAD_REQUEST,
                                &serde_json::json!({ "detail": "actors must be an array of strings" }),
                            ));
                        };
