CREATE TABLE IF NOT EXISTS PROJECT(
    ...
    -- Persisted share identity (uuid v4); set lazily on first publish, NULL until then.
    -- Also added via an idempotent migration (project_share_id) for pre-existing DBs.
    SHARE_ID        TEXT,
