...
export async function checkNewVersions(limit?: number): Promise<VersionCheckResult> {
  return libraryFetch<VersionCheckResult>("/api/versions/check", {
    method: "POST",
